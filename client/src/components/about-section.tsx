...
export default function AboutSection() {
  return (
    <section className="py-12 sm:py-16 lg:py-24 glass-bg-mesh relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4 md:gap-6">
              <div className="text-center p-3 sm:p-4 md:p-6 glass-panel rounded-2xl">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 glass-panel rounded-xl">
          ...
          <div className="relative mt-8 lg:mt-0">
            ...
            <div className="hidden sm:block absolute -bottom-4 sm:-bottom-8 -left-4 sm:-left-8 glass-panel-liquid rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-2xl">
              <div className="text-center">
                <div className="text-xl sm:text-2xl font-bold text-primary dark:text-tropical mb-1 glass-text-glow">57</div>
                <div className="text-xs sm:text-sm text-gray-800 dark:text-white/90 font-medium">Happy Reviews</div>
              </div>
            </div>

            {/* Floating Stats Card - Hidden on mobile, visible on larger screens */}
            <div className="hidden sm:block absolute -top-4 sm:-top-8 -right-4 sm:-right-8 glass-panel-liquid rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-2xl">
              <div className="text-center">
